...
def create_dataset(request):
    ...
    faceDetect = cv2.CascadeClassifier("C:\\Users\\Ganesh Kopparapu\\Desktop\\Smart-Search-Using-Face-Recognition-master\\Facial\\Facial\\ml\\haarcascade_frontalface_default.xml")
    ...
    while(True):
        ...
        for(x,y,w,h) in faces:
            ...
            path1='C:\\Users\\Ganesh Kopparapu\\Desktop\\Smart-Search-Using-Face-Recognition-master\\Facial\\Facial\\ml\\dataset\\User.'
...
def trainer(request):
    ...
    #Path of the samples
    path = 'C:\\Users\\Ganesh Kopparapu\\Desktop\\Smart-Search-Using-Face-Recognition-master\\Facial\\Facial\\ml\\dataset'
    ...
    recognizer.save('C:\\Users\\Ganesh Kopparapu\\Desktop\\Smart-Search-Using-Face-Recognition-master\\Facial\\Facial\\ml\\recognizer\\trainningData.yml')
    cv2.destroyAllWindows()
...
def detect(request):
    ...
    rec.read('C:\\Users\\Ganesh Kopparapu\\Desktop\\Smart-Search-Using-Face-Recognition-master\\Facial\\Facial\\ml\\recognizer\\trainningData.yml')
    getId = 0
